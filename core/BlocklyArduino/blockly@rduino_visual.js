...
BlocklyDuino.changeFontURL = function () {
    ...
    if (FontChoiceUrl === 'O') {
        document.body.style.fontFamily = 'OpenDyslexic';
        FontChoice = 'O';
    } else if (FontChoiceUrl === 'T') {
        document.body.style.fontFamily = 'Trebuchet MS';
        FontChoice = 'T';
    } else if (FontChoiceUrl === 'V') {
        document.body.style.fontFamily = 'V';
        FontChoice = 'V';
    } else {
        document.body.style.fontFamily = BLOCKIDE_UI_FONT;
        FontChoice = FontChoiceUrl || 'P';
    }
    return FontChoice;
};
