 ...
 */
// text_char block removed

/**
 * Single character literal block, outputs Character type.
 */
Blockly.Blocks['char'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("'")
        .appendField(new Blockly.FieldTextInput('A', function(text) {
          // Allow a single character or a number 0..255
          var s = (typeof text === 'string') ? text : 'A';
          if (/^\d{1,3}$/.test(s)) {
            var n = parseInt(s, 10);
    ...
    this.getBlockType = function() {
      return (Blockly.Types && Blockly.Types.CHARACTER) ? Blockly.Types.CHARACTER : 'String';
    };
    this.setTooltip('Single character literal. Outputs a char.');
  }
};
