...
// Pin management logic has been moved to blocks/arduino_base/arduino_io.js to avoid duplicates.
// This file now only contains base block definitions (setup, loop, etc.).
...
Blockly.Blocks['inout_digital_mode'] = {
  init: function () {
    ...
    this.appendDummyInput()
      ...
      .appendField(new Blockly.FieldDropdown(currentDigitalPins), 'PIN');
    this.appendDummyInput()
