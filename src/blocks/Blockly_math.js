...
Blockly.Blocks['math_change'] = {
  /**
   * Block for adding to or subtracting from a variable in place.
   * @this Blockly.Block
   */
  init: function() {
    var inc =
      typeof Blockly.Msg.MATH_CHANGE_INCREASE === 'string' &&
      Blockly.Msg.MATH_CHANGE_INCREASE.trim()
        ? Blockly.Msg.MATH_CHANGE_INCREASE
        : 'increase (+)';
    var dec =
      typeof Blockly.Msg.MATH_CHANGE_DECREASE === 'string' &&
      Blockly.Msg.MATH_CHANGE_DECREASE.trim()
    ...
    var thisBlock = this;
    this.setTooltip(function () {
      var tip = Blockly.Msg.MATH_CHANGE_TOOLTIP || '';
      var v = thisBlock.getFieldValue('VAR');
      return tip.replace(/%1/g, v == null ? '' : String(v));
    });
  },
};
