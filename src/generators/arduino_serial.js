...
Blockly.Arduino['serial_init'] = function() {
  var dropdown_speed = this.getFieldValue('SPEED') || '9600';
...
Blockly.Arduino.serial_println = function() {
  // Auto-inject Serial.begin(9600) if serial_init was not placed — safe fallback for beginners.
  // If the user places a serial_init block with a custom speed, it overwrites this same key.
