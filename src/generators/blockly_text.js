...
// --- from BlocklyArduino/text.js ---

// Generator for single character literal block
Blockly.Arduino['char'] = function(block) {
  var raw = block.getFieldValue('CHAR') || 'A';
  // If the user entered a number literal, treat it as a numeric char code
  if (/^\d{1,3}$/.test(raw)) {
