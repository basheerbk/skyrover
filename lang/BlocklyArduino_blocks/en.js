...
Blockly.Msg.ARDUINO_FUNC_DEFINE_VOID_TITLE = "function void";
Blockly.Msg.ARDUINO_FUNC_DEFINE_RETURN_TITLE = "function";
Blockly.Msg.ARDUINO_FUNC_IN_FUNCTION = "do";
...
Blockly.Msg.ARDUINO_FUNC_RETURN_TITLE = "return";
...
Blockly.Msg.ARDUINO_FUNC_CALL_VOID_TOOLTIP = "Runs the helper you built. Pick the helper name from the dropdown. Use the gear if your helper needs values.";
Blockly.Msg.ARDUINO_FUNC_CALL_RETURN_TOOLTIP = "Gets an answer from your value helper. Pick the helper name from the dropdown, then plug this into math or other blocks.";
