...
Blockly.Msg.ARRAY_GETINDEX_TOOLTIP1 = "returns the value stored in the list or array";
Blockly.Msg.ARRAY_GETINDEX_TOOLTIP2 = "creates a list or array of the selected type";
Blockly.Msg.ARRAY_GETINDEX_TOOLTIP3 = "sets one or more elements of the list or array to the specified value(s)";
...
Blockly.Msg.VARIABLES_SET_HELPURL = "https://www.arduino.cc/reference/en/language/variables/variable-declaration/";
Blockly.Msg.VARIABLES_SET = "set";
Blockly.Msg.MATH_CHANGE_TITLE = "%1 %2 by %3";
...
Blockly.Msg.VARIABLES_DECLARE_TYPED = "declare variable";
Blockly.Msg.VARIABLES_DECLARE_TYPED_TOOLTIP = "Declare a variable with a data type but no initial value.";
Blockly.Msg.VARIABLES_DECLARE_TYPED_HELPURL = "https://www.arduino.cc/reference/en/language/variables/data-types/";
...
Blockly.Msg.CAT_ARDUINO_FUNCTIONS = "Functions";
Blockly.Msg.ARDUINO_FUNC_DEFINE_VOID_TITLE = "make a step group";
Blockly.Msg.ARDUINO_FUNC_DEFINE_RETURN_TITLE = "make a value helper";
Blockly.Msg.ARDUINO_FUNC_IN_FUNCTION = "then";
Blockly.Msg.ARDUINO_FUNC_DEFINE_VOID_TOOLTIP = "Create a named group of blocks you can run again and again. Keep this block on the workspace (not inside loop). Use the gear to add inputs. Use “Run” blocks inside your program to use it.";
Blockly.Msg.ARDUINO_FUNC_DEFINE_RETURN_TOOLTIP = "Create a helper that gives back a number or value. Put a “return” block inside. Use the gear to add inputs.";
Blockly.Msg.ARDUINO_FUNC_RETURN_TITLE = "send back";
Blockly.Msg.ARDUINO_FUNC_RETURN_TOOLTIP = "Sends a value out of your helper (only inside a value helper).";
Blockly.Msg.ARDUINO_FUNC_RUN_LABEL = "Run";
Blockly.Msg.ARDUINO_FUNC_GET_LABEL = "Get";
Blockly.Msg.ARDUINO_FUNC_WITH_LABEL = "letter";
Blockly.Msg.ARDUINO_FUNC_AND_LABEL = "word";
Blockly.Msg.ARDUINO_FUNC_MUTATOR_TYPE_LETTER = "Letter";
Blockly.Msg.ARDUINO_FUNC_MUTATOR_NAME_WORD = "Word";
Blockly.Msg.ARDUINO_FUNC_CALL_VOID_TOOLTIP = "Runs the helper you built. Type the same name as on your “make a step group” block. Use the gear if your helper needs values.";
Blockly.Msg.ARDUINO_FUNC_CALL_RETURN_TOOLTIP = "Gets an answer from your value helper. Plug this into math or other blocks. Match the helper name and use the gear for inputs.";
Blockly.Msg.ARDUINO_FUNC_MUTATOR_PARAMS = "inputs for your helper";
Blockly.Msg.ARDUINO_FUNC_MUTATOR_TOOLTIP = "Add or remove inputs (type and name) — like ingredients your helper needs.";
Blockly.Msg.ARDUINO_FUNC_MUTATOR_PARAM_TOOLTIP = "Letter: pick the type. Word: the name you use for this input inside the helper.";
Blockly.Msg.ARDUINO_FUNC_MUTATOR_CALL_SLOTS_TITLE = "Add value slots";
Blockly.Msg.ARDUINO_FUNC_MUTATOR_CALL_SLOT_ITEM = "slot";
Blockly.Msg.CAT_ARDUINO = "Arduino";
Blockly.Msg.CAT_IO = "Arduino";
Blockly.Msg.CAT_TIME = "Time";
Blockly.Msg.CAT_SERIAL_MESSAGE = "Serial Message";
Blockly.Msg.CAT_CONTROLS = "Controls";
Blockly.Msg.CAT_LED = "LED";
Blockly.Msg.CAT_BUZZER = "Buzzer";
Blockly.Msg.CAT_SENSOR = "Sensors";
Blockly.Msg.CAT_SERVO = "Actuators";
...
Blockly.Msg.CAT_BLYNK_CC = "BLYNK.CC"; // legacy category (old blocks)
Blockly.Msg.CAT_BLYNK_IOT = "Blynk IOT"; // new ESP32 Blynk category
...
Blockly.Msg.CAT_ROBUNO_MOTORS_CC = "DC motors";
...
Blockly.Msg.CAT_FISCHERTECHNIK_MOTORS_CC = "DC motors";
...
Blockly.Msg.CAT_INFRA_2 = "Infrared"; //added august 22th 2018
Blockly.Msg.CAT_INFRA_3 = "Infrared";
...
Blockly.Msg.CAT_MULTIFUNCTION = "Multi-function";  //added march 9th 2016

Blockly.Msg.CAT_RFID = "RFID";  //added april 13th 2017

Blockly.Msg.CAT_KIT_VELO_1 = "OBC33 bike kit";
Blockly.Msg.CAT_KIT_VELO_2 = "OBC33 bike kit";
Blockly.Msg.CAT_KIT_VELO_3 = "OBC33 bike kit";  //added april 8th 2016

Blockly.Msg.CAT_MBOT_1 = "mBot";
Blockly.Msg.CAT_MBOT_2 = "mBoti";
...
Blockly.Msg.FIELDDROPDOWN = [["ON", "HIGH"], ["OFF", "LOW"]];
...
Blockly.Msg.ARDUINO_BASE_DELAY_DELAY_TIME = "wait";
Blockly.Msg.ARDUINO_BASE_DELAY_DELAY_TIME_SEC = "wait";
...
Blockly.Msg.ARDUINO_BASE_LOOP = "loop";
...
Blockly.Msg.ARDUINO_BASE_MAP_NUM = "remap";
Blockly.Msg.ARDUINO_BASE_MAP_DMAX = "from 0–1023 to 0–";
Blockly.Msg.ARDUINO_BASE_MAP_TOOLTIP = "Turns a sensor-style number (0–1023) into a smaller range (0 up to your max). Same idea as Arduino map().";
...
Blockly.Msg.ARDUINO_BASE_INCLUDE_FILE_TEXT = "Include file";
Blockly.Msg.ARDUINO_BASE_INCLUDE_FILE_NAME = "Filename";
Blockly.Msg.ARDUINO_BASE_INCLUDE_FILE_TOOLTIP = "Include a file from the working directory";
...
Blockly.Msg.ARDUINO_BASE_INCLUDE_LIB_TEXT = "Include library";
...
Blockly.Msg.STEM_TIP_SETUP_LABEL = "Tip: use TOP of Arduino program for setup (once)";
Blockly.Msg.STEM_TIP_SETUP_TOOLTIP =
  "The Arduino program block has two parts: setup (runs once) and loop (repeats). Put Add LED on pin, Serial begin, and similar blocks in the top (setup) area.";
Blockly.Msg.STEM_TIP_LOOP_LABEL = "Tip: use BOTTOM of Arduino program for loop (repeat)";
Blockly.Msg.STEM_TIP_LOOP_TOOLTIP = "Drag repeat, if, waits, and sensor blocks into the bottom (loop) area so the board keeps running your project.";
Blockly.Msg.STEM_TIP_MATH_LABEL = "Tip: drag numbers into other blocks";
Blockly.Msg.STEM_TIP_MATH_TOOLTIP = "Number blocks fit into delays, LED times, comparisons, map(), and more.";

Blockly.Msg.BASIC_ARDUINO_OUTPUT_SETUP_TITLE = "Set pin as OUTPUT";
Blockly.Msg.BASIC_ARDUINO_OUTPUT_SETUP_TOOLTIP =
  "Put in setup. Declares this digital pin as an output (LED, buzzer, relay signal, etc.). Other blocks may also set the pin if you skip this.";
Blockly.Msg.BASIC_DIGITAL_INPUT_SETUP_TITLE = "Set pin as INPUT";
Blockly.Msg.BASIC_DIGITAL_INPUT_SETUP_MODE = "mode";
Blockly.Msg.BASIC_DIGITAL_INPUT_PULLUP = "pull-up (buttons)";
Blockly.Msg.BASIC_DIGITAL_INPUT_PLAIN = "normal INPUT";
Blockly.Msg.BASIC_DIGITAL_INPUT_SETUP_TOOLTIP =
  "Put in setup before reading the pin with Digital read. Use pull-up for a button wired to GND; use normal INPUT for some sensors.";
Blockly.Msg.BASIC_BUTTON_SETUP_TITLE = "Add button on pin";
Blockly.Msg.BASIC_BUTTON_SETUP_TOOLTIP =
  "Put in setup. Turns on the internal pull-up for this pin — use when the button connects the pin to GND (reads LOW when pressed). Same as Set pin as INPUT with pull-up (buttons) mode.";
Blockly.Msg.BASIC_BUTTON_STATE_LABEL = "button";
Blockly.Msg.BASIC_BUTTON_STATE_PRESSED = "pressed";
Blockly.Msg.BASIC_BUTTON_STATE_NOT_PRESSED = "not pressed";
Blockly.Msg.BASIC_BUTTON_STATE_ON_PIN = "on pin";
Blockly.Msg.BASIC_BUTTON_STATE_TOOLTIP =
  "True when the button matches your choice. Wiring: button connects this pin to GND when pressed; internal pull-up on (Add button on pin in setup — this block also sets the pin if needed).";
Blockly.Msg.BASIC_BUTTON_PRESSED_TITLE = "button pressed on pin";
Blockly.Msg.BASIC_BUTTON_PRESSED_TOOLTIP =
  "True when the button is pressed. Wiring: one side of the button to this pin, other to GND (internal pull-up on — use Add button on pin in setup, or this block adds it too).";
Blockly.Msg.BASIC_BUTTON_NOT_PRESSED_TITLE = "button not pressed on pin";
Blockly.Msg.BASIC_BUTTON_NOT_PRESSED_TOOLTIP =
  "True when the button is up (not pressed). Same wiring as button pressed on pin.";
Blockly.Msg.BASIC_POTENTIOMETER_READ_TITLE = "potentiometer value on pin";
Blockly.Msg.BASIC_POTENTIOMETER_READ_TOOLTIP =
  "Read the knob value from 0 to 1023.";
Blockly.Msg.BASIC_POTENTIOMETER_SETUP_TITLE = "Add potentiometer on pin";
Blockly.Msg.BASIC_POTENTIOMETER_SETUP_TOOLTIP =
  "Put in setup. Prepares this analog pin to read knob values.";
Blockly.Msg.BASIC_SWITCH_STATE_TITLE = "switch";
Blockly.Msg.BASIC_SWITCH_STATE_ON = "ON";
Blockly.Msg.BASIC_SWITCH_STATE_OFF = "OFF";
Blockly.Msg.BASIC_SWITCH_STATE_ON_PIN = "on pin";
Blockly.Msg.BASIC_SWITCH_STATE_TOOLTIP =
  "True when the switch matches your choice. Uses pull-up wiring (switch to GND).";
Blockly.Msg.BASIC_SWITCH_SETUP_TITLE = "Add switch on pin";
Blockly.Msg.BASIC_SWITCH_SETUP_TOOLTIP =
  "Put in setup. Uses INPUT_PULLUP for a switch wired to GND.";
Blockly.Msg.BASIC_SERIAL_READ_TEXT_TITLE = "read serial text (string)";
Blockly.Msg.BASIC_SERIAL_READ_TEXT_TOOLTIP =
  "Read incoming text from Serial Monitor until a new line arrives.";
Blockly.Msg.BASIC_BUZZER_SETUP_TITLE = "Add buzzer on pin";
Blockly.Msg.BASIC_BUZZER_SETUP_TOOLTIP =
  "Put in setup. Sets the buzzer pin as OUTPUT. Other buzzer blocks also prepare the pin if you skip this.";
Blockly.Msg.BASIC_SERVO_SETUP_TITLE = "Add servo on pin";
Blockly.Msg.BASIC_SERVO_SETUP_TOOLTIP =
  "Put in setup. Attaches the servo on this PWM pin. Move servo also does this if you skip this block.";
Blockly.Msg.BASIC_SERVO_ANGLE_TITLE = "angle";
Blockly.Msg.BASIC_SERVO_ANGLE_TOOLTIP =
  "Shows one angle (0–180°). Click the number to open the protractor. You can replace this block with a plain number or a sensor.";
Blockly.Msg.BASIC_SERVO_ANGLE_POPUP_HINT = "Click or drag on the arc to set 0°–180°";
Blockly.Msg.BASIC_SERVO_MOVE_TOOLTIP =
  "Move a servo to an angle (0–180°). Click the angle to open the protractor, or use another number block, variable, or sensor.";
Blockly.Msg.BASIC_I2C_SETUP_TITLE = "Start I2C bus (for LCD / OLED)";
Blockly.Msg.BASIC_I2C_SETUP_TOOLTIP =
  "Put in setup once before LCD or OLED blocks. Runs Wire.begin() so I2C displays can talk to the board.";
Blockly.Msg.BASIC_OLED_SETUP_TITLE = "Add OLED display (setup)";
Blockly.Msg.BASIC_OLED_SETUP_ADDR = "address";
Blockly.Msg.BASIC_OLED_SETUP_TOOLTIP =
  "Put in setup once. Starts a 128x64 OLED at this I2C address and applies safe text defaults. Use 0x3C for most modules; switch to 0x3D if your display needs it.";
Blockly.Msg.BASIC_NEOPIXEL_SINGLE_TITLE = "Add NeoPixel on pin";
Blockly.Msg.BASIC_NEOPIXEL_COLOUR_LABEL = "with colour";
Blockly.Msg.BASIC_NEOPIXEL_SINGLE_TOOLTIP =
  "Set one NeoPixel LED (pixel 0) on this pin to the selected colour.";
Blockly.Msg.BASIC_NEOPIXEL_STRIP_SETUP_TITLE = "Add NeoPixel strip on pin";
Blockly.Msg.BASIC_NEOPIXEL_STRIP_COUNT_LABEL = "with";
Blockly.Msg.BASIC_NEOPIXEL_STRIP_COUNT_SUFFIX = "LEDs";
Blockly.Msg.BASIC_NEOPIXEL_STRIP_SETUP_TOOLTIP =
  "Put in setup. Creates a NeoPixel strip on this pin with this LED count.";
Blockly.Msg.BASIC_NEOPIXEL_SET_BRIGHTNESS_TITLE = "NeoPixel brightness on pin";
Blockly.Msg.BASIC_NEOPIXEL_SET_BRIGHTNESS_LABEL = "level";
Blockly.Msg.BASIC_NEOPIXEL_SET_BRIGHTNESS_TOOLTIP =
  "Set brightness for this NeoPixel strip (0 = off, 255 = very bright).";
Blockly.Msg.BASIC_NEOPIXEL_CLEAR_TITLE = "Turn off all NeoPixels on pin";
Blockly.Msg.BASIC_NEOPIXEL_CLEAR_TOOLTIP =
  "Turn off every LED in this NeoPixel strip.";
Blockly.Msg.BASIC_NEOPIXEL_FILL_TITLE = "Fill NeoPixel strip on pin";
Blockly.Msg.BASIC_NEOPIXEL_FILL_WITH = "with";
Blockly.Msg.BASIC_NEOPIXEL_FILL_COUNT_LABEL = "LED count";
Blockly.Msg.BASIC_NEOPIXEL_FILL_TOOLTIP =
  "Set every LED in this strip to one color.";
Blockly.Msg.BASIC_NEOPIXEL_SHOW_TITLE = "Show NeoPixel updates on pin";
Blockly.Msg.BASIC_NEOPIXEL_SHOW_TOOLTIP =
  "Show the latest NeoPixel changes now.";
Blockly.Msg.BASIC_NEOPIXEL_RAINBOW_TITLE = "Rainbow on pin";
Blockly.Msg.BASIC_NEOPIXEL_RAINBOW_COUNT_LABEL = "LED count";
Blockly.Msg.BASIC_NEOPIXEL_RAINBOW_DELAY_LABEL = "speed ms";
Blockly.Msg.BASIC_NEOPIXEL_RAINBOW_CYCLES_LABEL = "cycles";
Blockly.Msg.BASIC_NEOPIXEL_RAINBOW_TOOLTIP =
  "Play a rainbow animation across all LEDs.";
Blockly.Msg.BASIC_NEOPIXEL_COLOR_WIPE_TITLE = "Color wipe on pin";
Blockly.Msg.BASIC_NEOPIXEL_COLOR_WIPE_DELAY_LABEL = "step ms";
Blockly.Msg.BASIC_NEOPIXEL_COLOR_WIPE_TOOLTIP =
  "Light LEDs one-by-one with the selected color.";
Blockly.Msg.BASIC_NEOPIXEL_THEATER_CHASE_TITLE = "Theater chase on pin";
Blockly.Msg.BASIC_NEOPIXEL_THEATER_CHASE_DELAY_LABEL = "step ms";
Blockly.Msg.BASIC_NEOPIXEL_THEATER_CHASE_ROUNDS_LABEL = "rounds";
Blockly.Msg.BASIC_NEOPIXEL_THEATER_CHASE_TOOLTIP =
  "Make a fun chasing-light pattern.";

Blockly.Msg.BASIC_LDR_SETUP_TITLE = "Add LDR sensor on pin";
Blockly.Msg.BASIC_LDR_SETUP_TOOLTIP =
  "Put in setup. Sets the analog pin as INPUT for a light-dependent resistor (LDR). The light level block also configures the pin if you skip this.";
Blockly.Msg.BASIC_IR_SETUP_TITLE = "Add IR sensor on pin";
Blockly.Msg.BASIC_IR_SETUP_TOOLTIP =
  "Put in setup. Sets the pin as INPUT for an IR obstacle sensor. The object detected block does the same if you skip this.";
Blockly.Msg.BASIC_DHT_SETUP_TITLE = "Add DHT11 sensor on pin";
Blockly.Msg.BASIC_DHT_SETUP_TOOLTIP =
  "Put in setup. Starts the DHT11 on this pin. Temperature and humidity blocks also start the sensor if you skip this.";
Blockly.Msg.BASIC_ULTRASONIC_SETUP_TITLE = "Add ultrasonic sensor";
Blockly.Msg.BASIC_ULTRASONIC_TRIG_LABEL = "Trig pin";
Blockly.Msg.BASIC_ULTRASONIC_ECHO_LABEL = "Echo pin";
Blockly.Msg.BASIC_ULTRASONIC_SETUP_TOOLTIP =
  "Put in setup. Prepares Trig (OUTPUT) and Echo (INPUT) and adds the distance helper. The distance block does the same if you skip this.";
Blockly.Msg.BASIC_JOYSTICK_SETUP_TITLE = "Add joystick";
Blockly.Msg.BASIC_JOYSTICK_X_LABEL = "X pin";
Blockly.Msg.BASIC_JOYSTICK_Y_LABEL = "Y pin";
Blockly.Msg.BASIC_JOYSTICK_BTN_LABEL = "button pin";
Blockly.Msg.BASIC_JOYSTICK_SETUP_TOOLTIP =
  "Put in setup. Prepares joystick X and Y analog pins plus button pin with pull-up.";
Blockly.Msg.BASIC_JOYSTICK_X_TITLE = "joystick X on pin";
Blockly.Msg.BASIC_JOYSTICK_X_TOOLTIP = "Read joystick X axis value (0-1023).";
Blockly.Msg.BASIC_JOYSTICK_Y_TITLE = "joystick Y on pin";
Blockly.Msg.BASIC_JOYSTICK_Y_TOOLTIP = "Read joystick Y axis value (0-1023).";
Blockly.Msg.BASIC_JOYSTICK_BUTTON_TITLE = "joystick button pressed on pin";
Blockly.Msg.BASIC_JOYSTICK_BUTTON_TOOLTIP =
...
Blockly.Msg.ARDUINO_INOUT_DIGITAL_WRITE_INPUT1 = "set digital pin";
Blockly.Msg.ARDUINO_INOUT_DIGITAL_WRITE_INPUT2 = "to";
Blockly.Msg.ARDUINO_INOUT_DIGITAL_WRITE_TOOLTIP = "Set a digital pin to HIGH (ON) or LOW (OFF).";
Blockly.Msg.ARDUINO_INOUT_DIGITAL_READ_HELPURL = "http://arduino.cc/en/Reference/DigitalRead";
Blockly.Msg.ARDUINO_INOUT_DIGITAL_READ_INPUT = "read digital pin";
Blockly.Msg.ARDUINO_INOUT_DIGITAL_READ_TOOLTIP = "Read digital pin state: HIGH (ON) or LOW (OFF).";
Blockly.Msg.ARDUINO_INOUT_DIGITAL_READ_PULL_UP = "pull up";
Blockly.Msg.ARDUINO_INOUT_DIGITAL_READ_PULL_UP_TOOLTIP = "Read digital pin state with pull-up enabled for stable button input.";
Blockly.Msg.ARDUINO_INOUT_PWM_WRITE_HELPURL = "http://arduino.cc/en/Reference/AnalogWrite";
Blockly.Msg.ARDUINO_INOUT_PWM_WRITE_INPUT1 = "set pin power";
Blockly.Msg.ARDUINO_INOUT_PWM_WRITE_INPUT2 = "";
Blockly.Msg.ARDUINO_INOUT_PWM_WRITE_SUFFIX = "%";
Blockly.Msg.ARDUINO_INOUT_PWM_WRITE_TOOLTIP = "Set output power from 0% (off) to 100% (full). Use a PWM-capable pin.";
...
Blockly.Msg.ARDUINO_INOUT_ANALOG_READ_INPUT = "read analog pin";
Blockly.Msg.ARDUINO_INOUT_ANALOG_READ_TOOLTIP = "Returns a value from 0 to 1023.";
Blockly.Msg.ARDUINO_INOUT_ONOFF_HELPURL = "http://arduino.cc/en/Reference/Constants";
Blockly.Msg.ARDUINO_INOUT_STATE = "ON / OFF";
Blockly.Msg.ARDUINO_INOUT_ANGLE = "angle";
Blockly.Msg.ARDUINO_INOUT_ANGLE_TOOLTIP = "enter angle 0° to 360°";
...
Blockly.Msg.ARDUINO_SERVO_MOVE_DEGREE = "";
...
Blockly.Msg.ARDUINO_SERIAL_PRINT_CONTENT = "send message";
Blockly.Msg.ARDUINO_SERIAL_PRINTLN_CONTENT = "send message and new line";
Blockly.Msg.ARDUINO_SERIAL_PRINT_TAB_CONTENT = "print with tab data on serial port:";
Blockly.Msg.ARDUINO_SERIAL_PRINT_TOOLTIP = "Send text or numbers to Serial Monitor.";
...
//SERIAL
Blockly.Msg.Serial_Init = "start Serial Monitor at speed";
Blockly.Msg.Serial_Print = "serial print";
Blockly.Msg.Serial_Write = "serial write byte";
...
Blockly.Msg.Serial_read = "serial read one character";
Blockly.Msg.Serial_avai = "serial message available?";
...
Blockly.Msg.IR_init_TEXT = "Initialize detector";
Blockly.Msg.IR_init_TOOLTIP = "Initialize the infrared detector";
Blockly.Msg.IR_test_LED_TEXT = "Test with LED";
Blockly.Msg.IR_test_LED_TOOLTIP = "Test reception of an infrared code using an LED";
Blockly.Msg.IR_test_monitor_TEXT = "Test with monitor";
Blockly.Msg.IR_test_monitor_TOOLTIP = "Test reception of an infrared code using the Arduino serial monitor";
Blockly.Msg.IR_next_value_TEXT = "Go to next code";
Blockly.Msg.IR_next_value_TOOLTIP = "After each received code, notify the receiver it can accept a new code";
Blockly.Msg.IR_detection_TEXT = "Signal detected";
Blockly.Msg.IR_detection_TOOLTIP = "Check whether a signal has been detected by the infrared receiver";
Blockly.Msg.IR_reception_code_TEXT = "Received code";
Blockly.Msg.IR_reception_code_TOOLTIP = "Value of the code received by the infrared receiver";
...
Blockly.Msg.TECHNOZONE51_TEXT94 = "show on LCD";
Blockly.Msg.TECHNOZONE51_TEXT95 = "at";
Blockly.Msg.TECHNOZONE51_TEXT96 = "column (start at 0)";
Blockly.Msg.TECHNOZONE51_TEXT97 = "row (start at 0)";
Blockly.Msg.TECHNOZONE51_TEXT98 = "text";
Blockly.Msg.TECHNOZONE51_TEXT99 = "Show text on LCD at the selected column and row.";
...
Blockly.Msg.multifunction_analog_read_TOOLTIP = "only A5 is available";
Blockly.Msg.multifunction_PWM_write_OUTPUT = "send to PWM~ output";
Blockly.Msg.multifunction_PWM_write_ANGLE = "value";
Blockly.Msg.multifunction_PWM_write_TOOLTIP = "digital or 'analog' PWM output";
Blockly.Msg.multifunction_tone_INPUT1 = "emit a sound on the buzzer";
Blockly.Msg.multifunction_tone_INPUT2 = "with frequency (Hz)";
Blockly.Msg.multifunction_tone_INPUT3 = "for a duration (ms) of";
Blockly.Msg.multifunction_tone_TOOLTIP = "buzzer connected to digital output D";
Blockly.Msg.multifunction_notone_INPUT = "stop sound on pin";
Blockly.Msg.multifunction_notone_TOOLTIP = "sets the buzzer to 0";
Blockly.Msg.multifunction_segment_TEXT = "display number";
Blockly.Msg.multifunction_segment_INPUT1 = "1st digit";
Blockly.Msg.multifunction_segment_INPUT2 = "2nd digit";
Blockly.Msg.multifunction_segment_INPUT3 = "3rd digit";
Blockly.Msg.multifunction_segment_INPUT4 = "4th digit";
Blockly.Msg.multifunction_segment_TOOLTIP = "display 4 digits on the 7‑segment display";
...
Blockly.Msg.RF433_rx_TOOLTIP = "Get the content of the message received by the radio receiver";
...
Blockly.Msg.FLYCAM_SWITCH_HELPURL = "";
...
Blockly.Msg.ARDUINO_INOUT_DIGITAL_MODE_INPUT1 = "set pin";
...
Blockly.Msg.ARDUINO_INOUT_DIGITAL_MODE_TOOLTIP = "Choose how a pin works: INPUT, OUTPUT, or INPUT_PULLUP for buttons.";
...
Blockly.Msg.CAT_DISPLAY_LCD = "LCD (I2C)";
Blockly.Msg.CAT_DISPLAY_OLED = "OLED";
...
Blockly.Msg.CAT_LDR_SENSORS = "LDR Sensors";
Blockly.Msg.CAT_TEMP_SENSORS = "DHT";

// LDR Sensor Blocks
Blockly.Msg.LDR_READ_TEXT = "Read LDR on pin";
Blockly.Msg.LDR_READ_TOOLTIP = "Read analog value from LDR sensor (0-1023)";

Blockly.Msg.LDR_THRESHOLD_TEXT = "LDR on pin";
Blockly.Msg.LDR_THRESHOLD_IS = "is";
Blockly.Msg.LDR_THRESHOLD_BRIGHTER = "brighter than";
Blockly.Msg.LDR_THRESHOLD_DARKER = "darker than";
Blockly.Msg.LDR_THRESHOLD_THRESHOLD = "threshold";
Blockly.Msg.LDR_THRESHOLD_TOOLTIP = "Check if LDR reading is above/below threshold";

Blockly.Msg.LDR_LIGHT_LEVEL_TEXT = "LDR light level on pin";
Blockly.Msg.LDR_LIGHT_LEVEL_TOOLTIP = "Classify light level as Very Dark, Dark, Medium, Bright, or Very Bright";

Blockly.Msg.LDR_AUTO_ADJUST_TEXT = "Auto-adjust based on LDR on pin";
Blockly.Msg.LDR_AUTO_ADJUST_IF_BRIGHT = "if bright";
Blockly.Msg.LDR_AUTO_ADJUST_IF_DARK = "if dark";
Blockly.Msg.LDR_AUTO_ADJUST_TOOLTIP = "Automatically execute different actions based on light level";

Blockly.Msg.LDR_CALIBRATE_TEXT = "Calibrate LDR on pin";
Blockly.Msg.LDR_CALIBRATE_WITH_SAMPLES = "with samples";
Blockly.Msg.LDR_CALIBRATE_TOOLTIP = "Calibrate LDR by taking multiple readings and calculating average";

// Temperature Sensor Blocks
Blockly.Msg.TEMP_READ_TEXT = "Read temperature on pin";
Blockly.Msg.TEMP_READ_TOOLTIP = "Read temperature value from sensor (°C)";

Blockly.Msg.TEMP_THRESHOLD_TEXT = "Temperature on pin";
Blockly.Msg.TEMP_THRESHOLD_IS = "is";
Blockly.Msg.TEMP_THRESHOLD_ABOVE = "above";
Blockly.Msg.TEMP_THRESHOLD_BELOW = "below";
Blockly.Msg.TEMP_THRESHOLD_THRESHOLD = "threshold";
Blockly.Msg.TEMP_THRESHOLD_TOOLTIP = "Check if temperature is above/below threshold";

Blockly.Msg.TEMP_CONVERT_TEXT = "Convert temperature";
Blockly.Msg.TEMP_CONVERT_C_TO_F = "Celsius to Fahrenheit";
Blockly.Msg.TEMP_CONVERT_F_TO_C = "Fahrenheit to Celsius";
Blockly.Msg.TEMP_CONVERT_TOOLTIP = "Convert between Celsius and Fahrenheit";

// LDR Setup Block
Blockly.Msg.LDR_SETUP_TEXT = "Add LDR sensor at input pin";
Blockly.Msg.LDR_SETUP_TOOLTIP = "Initialize LDR sensor pin for analog reading (e.g., A0, A1, A2)";

// Temperature Setup Block
Blockly.Msg.TEMP_SETUP_TEXT = "Add temperature sensor at input pin";
Blockly.Msg.TEMP_SETUP_TOOLTIP = "Initialize temperature sensor pin for analog reading (e.g., A0, A1, A2)";

Blockly.Msg.VARIABLES_DECLARE = "declare variable";
Blockly.Msg.VARIABLES_DECLARE_HELPURL = "https://www.arduino.cc/reference/en/language/variables/variable-scope-qualifiers/scope/";
Blockly.Msg.VARIABLES_DECLARE_TOOLTIP = "Declare a variable with a specific data type without initial value";

// Blink Bot Category
Blockly.Msg.CAT_BLINKBOT = "Blink Bot";

// Robot Misc Category (contains IR blocks - keeping for now)
Blockly.Msg.CAT_ROBOT_MISC = "IR";

// Sensors Category
Blockly.Msg.CAT_SENSORS = "Sensors";
Blockly.Msg.CAT_MPU6050 = "MPU6050";
Blockly.Msg.MPU6050_INIT_TEXT = "Setup MPU6050";
Blockly.Msg.MPU6050_INIT_ADDRESS = "I2C Address";
Blockly.Msg.MPU6050_INIT_TOOLTIP = "Initialize MPU6050 6-axis motion sensor (accelerometer + gyroscope)";
Blockly.Msg.MPU6050_READ_ACCEL = "MPU6050 Acceleration";
Blockly.Msg.MPU6050_READ_ACCEL_TOOLTIP = "Read acceleration on X, Y, or Z axis (raw value: -32768 to 32767)";
Blockly.Msg.MPU6050_READ_GYRO = "MPU6050 Rotation";
Blockly.Msg.MPU6050_READ_GYRO_TOOLTIP = "Read gyroscope rotation on X, Y, or Z axis (raw value: -32768 to 32767)";

Blockly.Msg.CAT_BMP280 = "BMP280";
Blockly.Msg.BMP280_INIT_TEXT = "Setup BMP280";
Blockly.Msg.BMP280_INIT_ADDRESS = "I2C Address";
Blockly.Msg.BMP280_INIT_TOOLTIP = "Initialize BMP280 barometric pressure sensor (temperature + pressure + altitude)";
Blockly.Msg.BMP280_READ_TEMP = "BMP280 Temperature (°C)";
Blockly.Msg.BMP280_READ_TEMP_TOOLTIP = "Read temperature in degrees Celsius";
Blockly.Msg.BMP280_READ_PRESSURE = "BMP280 Pressure (Pa)";
Blockly.Msg.BMP280_READ_PRESSURE_TOOLTIP = "Read atmospheric pressure in Pascals";
Blockly.Msg.BMP280_READ_ALTITUDE = "BMP280 Altitude (m)";
Blockly.Msg.BMP280_READ_ALTITUDE_TOOLTIP = "Calculate altitude in meters based on sea level pressure";

// Math dropdown: use ASCII so + − × ÷ do not turn into garbled glyphs on some Windows fonts.
